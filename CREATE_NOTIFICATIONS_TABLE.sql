...
BEGIN
  ...
  SELECT 
    ...
    COUNT(*) FILTER (WHERE type = 'promotion') AS promotion_notifications,
...
-- Insert sample notifications to test (with correct types)
...
-- Verify the tables and functions were created
SELECT COUNT(*) as notification_count FROM notifications;
SELECT * FROM get_notification_stats('0295638e-27f2-45eb-ac0b-be7d8f2d0bf3');
SELECT * FROM get_admin_notification_stats();